...
$kosik = $_SESSION['kosik'];
	...
	header("Location:potvrdenie_objednavky.php?cena=$cena&adresa=$adresa&osoba=$osoba&email=$email");
}
...
<div class="container">
  ...
  <div class="content">
	...
	<p><? echo $kosik->writeKosik(); ?></p><p><center><b>Cena spolu: <? echo $kosik->getSumarize(); ?>€</b></p>
