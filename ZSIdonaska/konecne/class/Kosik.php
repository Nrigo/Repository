...
public function pridatDoKosika($idPizza,$pocet){
...
public function odobratZKosika($idPizza){
...
public function odobratZKosikaPodlaIndexu($index){
...
public function writeKosikDonaska(){
...
public function getPizzaStringg(){
	$string = "";
	for($i=0;$i<$this->maxIndexPizza;$i++){
	   if($this->pizza[$i]!=null){
...
public function getPocetPizza(){
  return $this->pocetPizza;
}

public function getSumarize(){
