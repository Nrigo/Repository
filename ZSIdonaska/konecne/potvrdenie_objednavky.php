...
$sprava = "Meno zákazníka:   " . $_POST['osoba'] . "\r\n" .
...
<div class="container">
  ...
  <div class="content">
    ...
    Na zadaný emial: <? echo $_GET["email"]; ?> vám bolo poslané potvrdenie objednávky.
    Prehľad objednávky:</p>
   
   <table cellpadding="0" cellspacing="1" class="registration">
              <tr>
                <th class="fltlft">Celková cena:</th>
                <td>
                  <? echo $_GET["cena"]; ?>
                </td>
              </tr>
              <tr>
                <th class="fltlft">Na adresu:</th>
                <td>
                  <? echo $_GET["adresa"]; ?>
                </td>
              </tr>
               <tr>
                <th class="fltlft">Kontaktná osoba:</th>
                <td>
                   <? echo $_GET["osoba"]; ?>
                </td>
              </tr>
